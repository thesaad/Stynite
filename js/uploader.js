...
function uploadCsv(url,formID,fileUpload,fileName,originalName,loading,filePreview,source)
{
	 if(confirm("Are you sure want to import data? "))
  {
        ...
        $.ajax({
            ...
            success: function(response) {
                setTimeout(function(){
                category_completeHandlerCsv(response,fileName,originalName,fileUpload,loading,original_name,source);
                },1500);
                },
            data: formData,
            cache: false,
...
function category_completeHandlerCsv(response,fileName,originalName,fileUpload,loading,original_name,source)
{
