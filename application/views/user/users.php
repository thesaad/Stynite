       ...
       <div class="pageicon"><span class="iconfa-group"></span></div>
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                      <?php $this->view("user/user_keywords");?>
                    <h4 class="widgettitle">Users
   <!--                 	
					...
					<thead>
						<tr>
						 ...
						 <th style="cursor: pointer">Contact</th>
							...
							<th style="cursor: pointer">Profile Picture</th>
							<th style="cursor: pointer">Registeration Date</th>
...
{
  if(confirm("Are you sure want to change account status ? "))
  {
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#employee-grid').DataTable( {
					...
					"order": [[ 4, "desc" ]],
					"ajax":{
						url :'<?=site_url('user/get_users_dt');?>', // json datasource
