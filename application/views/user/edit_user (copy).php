            ...
            <div class="maincontentinner">
               <div class="widgetbox box-inverse">
                ...
                <div class="widgetcontent wc1">
                    <form action="<?=site_url('admin/save_product');?>" method="post" class="stdform" id="form1" novalidate="novalidate">
...
<span class="field">
<input class="input-medium" name="input2" placeholder="Username" type="text">
</span>
</p>                            
           <p>
<label>Name</label>
<span class="field">
<input class="input-medium" name="input2" placeholder="Firstname" type="text">
<input class="input-medium" name="input2" placeholder="Lastname" type="text">
</span>
</p>
              <div class="par control-group">
                                    <label for="page_title" class="control-label">Email</label>
                                <div class="controls item"><input type="text" required="required" value="<?=(isset($product[0]->title))?$product[0]->title:"";?>" class="input-large" id="title" name="title" placeholder="Email" /></div>
                            </div>
...
<span class="field">
<input id="datepicker" class="input-small hasDatepicker" name="date" type="text">
</span>
</div>
                                  <div class="par control-group">
                                    ...
                                    <div data-provides="fileupload" class="fileupload fileupload-<?=$exist_image;?>">
                        				<div class="input-append" id="iconUpload">
                            				...
                            				<span class="btn btn-file">
                            				   ...
                            				   -->
                            				    <input type="file" name="business_pic" onchange="uploadImage('<?php echo site_url('file/upload_image'); ?>','form1','business_pic','business_photo_name','business_original_name','icon_file_loading','fileupload-preview','userimage')" />
