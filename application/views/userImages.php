...
<div class="rightpanel">
        ...
        <ul class="breadcrumbs">
           ...
           <?php if(isset($pic_of_day[0]['image']))
				{
					$img_day=$pic_of_day[0]['image'];
				}else{
					$img_day="no_image.jpg";
				}
               ?>
        ...
        <div class="pageheader">
           ...
           <div class="pagetitle" style="margin-left:110px;">
           	
            	  <h1><?php echo $userdetail[0]['name'];?></h1>
               
                	<b><?php echo $userdetail[0]['email'];?><b>
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                    ...
                    <h4 class="widgettitle">User Images
             ...
             <table id="employee-grid"  class="table table-bordered table-infinite" cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
					<thead>
						<tr>
							...
							<th style="cursor: pointer">Datetime</th>
...
function delete_group_image(id,image)
{
  ...
  {
     $.ajax({
        url         :'<?=site_url('admin/remove_group_image');?>',
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#employee-grid').DataTable( {
					...
					"order": [[ 2, "desc" ]],
					"ajax":{
						url :'<?=site_url('admin/getUserImagesDt').'/'.$userdetail[0]['id'];?>', // json datasource
