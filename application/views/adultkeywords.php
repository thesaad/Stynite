...
<div class="rightpanel">
       ...
       <div class="pageicon"><span class="iconfa-list"></span></div>
            <div class="pagetitle">
                <h1>Adult Keywords filter</h1>
            </div>
        </div><!--pageheader-->
        <div class="maincontent">
            <div class="maincontentinner">
                    
                    <h4 class="widgettitle">Adult Keywords filter
                  	
<a style="float: right; margin-top: -8px;" onclick="keyword_action('delete')" title="Delete Selected Retailer" class="btn btn-danger btn-rounded"><i class="iconfa-trash"></i>&nbsp;Delete Selected</a>
 
 <a href="<?php echo site_url("admin/manage_adultkeyword");?>" style="float: right; margin-top: -8px;"  title="Add" class="btn btn-success btn-rounded"><i class="iconfa-plus"></i>&nbsp;Add</a>
             ...
             <table id="employee-grid"  class="table table-bordered table-infinite" cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
					<thead>
						<tr>
							<th style="width:100px; cursor: pointer" >Sr. no.</th>
    ...
    function keyword_action(action)
{
  ...
  if(confirm("Are you sure want to "+action+" ? "))
  {
       var formData = new FormData($('#keywordaction')[0]);
              		    ...
              		    type: "post",
             			url : "<?php echo site_url("admin/adultkeywordaction");?>",
               			data: formData,
                        contentType: false,
                        processData: false,
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#employee-grid').DataTable( {
					...
					"order": [[ 1, "asc" ]],
					"ajax":{
						url :'<?=site_url('admin/get_adultkeywords_dt');?>', // json datasource
