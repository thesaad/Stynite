        ...
        <div class="maincontent">
            <div class="maincontentinner">
                    ...
                    <div class="row-fluid">
				         ...
				         <div class="span12">
                    <h4 class="widgettitle">Affiliate retailers
         <!--           	
...
-->
            ...
            <table id="retailer-grid"  class="table table-bordered table-infinite" cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
					<thead>
						<tr>
							<th  >Sr. no.</th>
	...
	<td><?php echo $value['storeName'];?></td>
							 ...
							 <td>
							 	<a target="blank" href="<?php echo site_url("retailer_store/affilate_retailer_products")."?merchant=".$value['merchantname'];?>" class="label label-primary">View</a>
							 </td>
							  <td>
							 	<a target="blank" href="<?php echo site_url("retailer_store/online_retailer_statistics")."?id=".$value['merchantname'];?>" class="label label-warning"><i class="icon-shopping-cart"></i></a>
							 </td>
