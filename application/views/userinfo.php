...
<div class="mainwrapper" style="background-color: #eee;">
    ...
    <div class="header">
        <div class="logo" style="height: 40px; padding-top: 3px !important; color: white !important; font-size: 20px!important;">
            <a href=""><img src="<?php echo base_url(); ?>logo.png" alt="" style="margin-left: 230px;" height="100px" width="100px"  /></a>
        </div>
    ...
    <div class="rightpanel" style="margin-left: 200px; margin-right: 200px;">
        ...
        <div class="pageheader">
            ...
            <div class="pagetitle">
                ...
                <h1>Kindly fill this form to start processing your payment</h1>
            </div>
        </div><!--pageheader-->
        ...
        <div class="maincontent">
            ...
            <!-------------------------end pricing--------------------->
            <div class="widget">
            <h4 class="widgettitle">Beneficiary's Details</h4>
            <div class="widgetcontent">
                      ...
                      <input type="hidden" name="token" value="<?php echo (isset($_GET['token']))?$_GET['token']:"";?>" />
                          <p>
                            ...
                            <span class="field"><input type="text" name="beneficiary_name"  class="input-xlarge validate[required]" /></span>
                        </p> 	
                       
                        
                        <p>
                            <label>Beneficiary's Country</label>
                            <span class="field">
...
<option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <p>
                            ...
                            <span class="field">
                            	<textarea rows="3" class="validate[required]" name="address" cols="6"></textarea>
                            	
                            </span>
                        </p>
     
                         <p>
                            <label>Remeeting Currency</label>
                            <span class="field"><input type="text" name="remeeting_currency" class="input-xlarge validate[required]"  /></span>
                        </p>
                        <p>
                            <label>Beneficiary's Account No.</label>
                            <span class="field"><input type="text" name="account_no" class="input-xlarge validate[required]" /></span>
                        </p>
                         <p>
                            <label>Beneficiary's Bank</label>
                            <span class="field"><input type="text" name="bank" class="input-xlarge validate[required]"  /></span>
                        </p>
                         <p>
                            <label>Beneficiary's Bank Country</label>
                            <span class="field"><select name="bankcountry" class="validate[required]">
<option value="">Country...</option>
<option value="Afganistan">Afghanistan</option>
<option value="Albania">Albania</option>
<option value="Algeria">Algeria</option>
...
<option value="Zimbabwe">Zimbabwe</option>
                        ...
                        <p>
                            ...
                            <span class="field">
                            	<textarea rows="3" class="validate[required]" name="bankaddress" cols="6"></textarea>
                            	
                            </span>
                        </p>
                        
                        <p>
                            <label>Swift code/Chips Id/Australia BSB Code/USA Fed Wire/USA ABA/UK Sort Code</label>
                            <span class="field"><input type="text" name="code" class="input-xlarge validate[required]"  /></span>
                        </p>
    ...
    $(document).ready(function(){
        function submit_form(formData,status)
        {
            if(status==true)
            {
        		...
        		$.ajax({
        			url		:	"<?php echo site_url('information/save_information'); ?>",
        			type	:	"POST",
        			data	:	querystr,
                beforeSend  :   function(){
                                    $(".loader").show();
