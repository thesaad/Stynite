...
<div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            ...
            <li><a href="<?php echo site_url('admin/index'); ?>">Group</a> <span class="separator"></span> Add Group</li>
            <li class="right">
        ...
        <div class="maincontent">
            <div class="maincontentinner">
               <div class="widgetbox box-inverse">
                <h4 class="widgettitle">Add-Group <span class="back_event"><a href="javascript:void(0);" onclick="history.back()"><i class=" iconfa-arrow-left"></i> Back</a></span></h4>
                <div class="widgetcontent wc1">
                    <form action="<?=site_url('admin/save_group');?>" method="post" class="stdform" id="form1" novalidate="novalidate">
                            <input type="hidden" value="<?=(isset($group[0]->id))?$group[0]->id:"";?>" name="id"  />
                            <div class="par control-group">
                                    <label for="page_title" class="control-label">Group Name</label>
                                <div class="controls item"><input type="text" required="required" value="<?=(isset($group[0]->group_name))?$group[0]->group_name:"";?>" class="input-xxlarge" id="group_name" name="group_name" placeholder="Group Name" /></div>
                            </div>
