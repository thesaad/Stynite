...
<div style="line-height: 18px;"><b style="line-height: 18px;">Total buy link clicked:&nbsp;<span style="color: #b84082;"><?php echo $product_buylink_click_count;?></span></b> &nbsp;|&nbsp;
 <b style="line-height: 18px;">Total buy:&nbsp;<span style="color: #b84082;"><?php echo $product_buy_count;?></span></b></div>
            </div>
 ...
 $(function () {
    Highcharts.chart('container', {
        ...
        },
        {
            ...
            name: 'Buy link clicked',
            data:  <?php echo  $buylink_click_data;?>
        }, {
            name: 'Buy',
            data:  <?php echo  $buy_data;?>
        }]
    });
});
