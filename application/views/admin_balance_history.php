       ...
       <div class="pageicon"><span class="iconfa-money"></span></div>
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                    ...
                    <h4 class="widgettitle">Balance History
                   <!-- 	
             ...
             <table id="employee-grid"  class="table table-bordered table-infinite" cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
					<thead>
						<tr>
							...
							<th style="cursor: pointer">Retailer Name</th>
			
						 
							
							<th style="cursor: pointer">Amount</th>
							<th style="cursor: pointer">Retailer Amount</th>
							<th style="cursor: pointer"> Your Amount</th>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#employee-grid').DataTable( {
					...
					"order": [[ 4, "desc" ]],
					"ajax":{
						url :'<?=site_url('admin/get_admin_balancehistory_dt');?>', // json datasource
