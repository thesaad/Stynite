...
<div class="rightpanel">
       ...
       <div class="pageicon"><span class="iconfa-laptop"></span></div>
            <div class="pagetitle">
                   <h1>Retailer: <span style="color: red"><?php echo $retailer[0]['merchant']?> </span></h1>
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $value['countdata'];?></td>
							 <td>
	<a   href="<?php echo site_url('retailer_store/onlineproduct_statistics').'?id='.$id;?>" title="Statistics"><i class="icon-signal"></i></a>    
