...
<div class="rightpanel">
       ...
       <div class="pageicon"><span class="iconfa-list"></span></div>
            <div class="pagetitle">
                <h1>Products by <span style="color: red"><?php echo $retailer;?> </span></h1>
            </div>
        </div><!--pageheader-->
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#employee-grid').DataTable( {
					...
					"order": [[ 4, "desc" ]],
					"ajax":{
						url :'<?=site_url('retailer_store/get_shopretailerproducts_dt')."?merchant=".$_GET['merchant'];?>', // json datasource
