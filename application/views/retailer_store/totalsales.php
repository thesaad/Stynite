...
<div class="rightpanel">
        ...
        <ul class="breadcrumbs">
            <li><a href="<?=site_url('admin/retailers');?>"><i class="iconfa-home"></i></a> <span class="separator"></span></li>
            <li>Total Sales</li>
       ...
       <div class="pageicon"><span class="iconfa-list"></span></div>
        ...
        <div class="maincontent">
            <div class="maincontentinner">
                    ...
                    <h4 class="widgettitle">Total Sales
                   <!-- 	
             ...
             <table id="employee-grid"  class="table table-bordered table-infinite" cellpadding="0" cellspacing="0" border="0" class="display" width="100%">
					<thead>
						<tr>
							...
							<th style="cursor: pointer">Total Sales</th>
		...
		<script type="text/javascript" language="javascript" >
			$(document).ready(function() {
				var dataTable = $('#employee-grid').DataTable( {
					...
					"order": [[ 1, "desc" ]],
					"ajax":{
						url :'<?=site_url('retailer_store/get_totalsales_dt');?>', // json datasource
