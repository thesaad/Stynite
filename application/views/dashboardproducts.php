...
-->
	...
	<a   href="<?php echo site_url("admin/manage_product")."?id=".$id;?>" title="Edit"><i class="icon-edit"></i></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a  onclick="product_id('<?php echo $id;?>')" data-toggle="modal" data-target="#myModal" style="cursor:pointer;" data-id="<?php echo $id;?>"   title="Send Notification"><i class="icon-bell"></i></a>
