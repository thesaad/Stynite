<?php
class Retailer_store extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('retailer_store_model');
	...
	$data['products']=$products;
	    ...
	    function retailer_statistics()
    {
    	$retailer = $this->admin_model->get_a_retailer($_GET['id']);
	  $data['retailer'] = $retailer;
        @$products = "";
       $products = $this->retailer_store_model->get_products_dashboard("VIEWED");
	    $searched = $this->retailer_store_model->get_products_dashboard("SEARCHED");
		 $clickbuy = $this->retailer_store_model->get_products_dashboard("CLICK_BUY_LINK");
		  $buy = $this->retailer_store_model->get_products_dashboard("BUY");
	...
	$data['products']=$products;
        $this->load->view('templates/header', $data);
        $this->load->view('retailer_store/dashboardproducts',$data);
    }

	    function online_retailer_statistics()
    {
    	$retailer[] =  array("merchant"=>$_GET['id']);
	  $data['retailer'] = $retailer;
        @$products = "";
       $products = $this->retailer_store_model->get_onlineproducts_dashboard("VIEWED");
	    $searched = $this->retailer_store_model->get_onlineproducts_dashboard("SEARCHED");
		 $clickbuy = $this->retailer_store_model->get_onlineproducts_dashboard("CLICK_BUY_LINK");
		  $buy = $this->retailer_store_model->get_onlineproducts_dashboard("BUY");
	...
	$data['products']=$products;
        $this->load->view('templates/header', $data);
        $this->load->view('retailer_store/dashboardproducts_online',$data);
    }	
  ...
  ////end of linkshare 
    ...
    function sales()
    {
	  ...
	  $data['retailer'] = $retailer;
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('retailer_store/sales',$data);
    }
        ...
        function totalsales()
    {
	  ...
	  $data['retailer'] = $retailer;
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('retailer_store/totalsales',$data);
    }
	  ...
	  function retailer_products()
    {
	  ...
	  $data['retailer'] = $retailer;
        ...
        $this->load->view('retailer_products',$data);
		  ...
		  function affilate_retailer_products()
    {
        $retailer = $_GET['merchant'];
        $data['active_page'] = 'affiliate_retailers';
	  $data['retailer'] = $retailer;
        $this->load->view('templates/header', $data);
        $this->load->view('retailer_store/affilate_retailer_products',$data);
    }
	
 function manage_product()
    {
    	 $retailer = $this->admin_model->get_a_retailer($_GET['retailer_id']);
		 $data['retailer'] = $retailer;
        @$product = "";
    ...
    $keywords = $this->retailer_store_model->get_keywords();    
  $data['keywords'] = $keywords;
  $data['product'] = $product;
  $data['product_keyword_ids'] = $product_keyword_ids;
           $data['active_page'] = 'manage_product';
        $this->load->view('templates/header', $data);
        $this->load->view('retailer_store/manage_product');
    }

 function  onlineproduct_statistics()
    {
        @$product = "";
		$product_keyword_ids = array();
        if (!isset($_GET['id'])) {
            ...
            $id = $_GET['id'];
            $product = $this->retailer_store_model->get_shopproducts($id);
             
        }
    $product_view = $this->retailer_store_model->get_shopproducts_stats($id,"VIEWED");
	$product_search = $this->retailer_store_model->get_shopproducts_stats($id,"SEARCHED");
	$product_buylink_click = $this->retailer_store_model->get_shopproducts_stats($id,"CLICK_BUY_LINK");
	$product_buy  = $this->retailer_store_model->get_shopproducts_stats($id,"BUY");
	 
	$product_view_count = $this->retailer_store_model->get_shopproducts_stats_total($id,"VIEWED");
	$product_search_count = $this->retailer_store_model->get_shopproducts_stats_total($id,"SEARCHED");
	$product_buylink_click_count = $this->retailer_store_model->get_shopproducts_stats_total($id,"CLICK_BUY_LINK");
	$product_buy_count  = $this->retailer_store_model->get_shopproducts_stats_total($id,"BUY");
  ...
  $data['product'] = $product;
           ...
           $data['active_page'] = 'affiliate_retailers';
        $this->load->view('templates/header', $data);
        $this->load->view('retailer_store/shop_product_statistics');
    }
 ...
 $data['keyword'] = $keyword;
		...
		function save_product()
	{
		...
		if(isset($_POST['id'])){
		    ...
		    $res = $this->retailer_store_model->save_product($id);
        if ($res) {
            redirect('admin/retailer_products?id='.$retailer_id);
        } else {
		...
		function get_shopretailerproducts_dt()
	{
		...
		$user = $this->retailer_store_model->get_shopretailerproducts_dt();
		echo json_encode($user); 
	}
		...
		function get_sales_dt()
	{
		...
		$retailer = $this->retailer_store_model->get_sales_dt();
		echo json_encode($retailer); 
	}
		function get_totalsales_dt()
	{
		 
		$retailer = $this->retailer_store_model->get_totalsales_dt();
		echo json_encode($retailer); 
	}
