...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
    ...
    public function _remap($object_called, $arguments)
    {
        ...
        $controller_method =str_replace('-', '_', $object_called);
	...
	// auth check
function Auth_Validate($auth_key,$user_id)
	{
	
		 $result= $this->rest->db
            ->where('auth_token', $auth_key)
			->where('id',$user_id)
...
function ShowAuthError()
	{
		 $this->response(array('message' => "Your request are not authorised. ", 'status' => 0), 200);
	}
//end of auth check
    /**
     * Detect format
    ...
    function webservices_validate_api_key($input) {
      if(array_key_exists('outh_token', $input)) {
        if($input['outh_token'] != '' && trim($input['outh_token']) == $this->variable_get('webservices_api_key', md5(md5('trail-guide123')))) {
          return TRUE;
        }
    	else {
    	  $this->response(array('message'=>'Invalid outh_token','status'=>0),200);
    	}
      }
      else {
        $this->response(array('message'=>'outh_token required','status'=>0),200);
      }  
    }
     function validate_param($op,$input)
    {
            // validate the api key for security//
            //$this->webservices_validate_api_key($input);
            if($op == 'update-user') {
                if(!(array_key_exists('user_id', $input) &&array_key_exists('city', $input)&&array_key_exists('state', $input)&&array_key_exists('country', $input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
            elseif($op == 'register') {
                if(!(array_key_exists('password',$input)&&array_key_exists('email', $input)&&array_key_exists('username', $input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
             elseif($op == 'login') {
                if(!(array_key_exists('password',$input)&&(array_key_exists('username', $input)))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
          elseif($op == 'user_register') {
                ...
                array_key_exists('username',$input)&&array_key_exists('dob',$input)
                &&array_key_exists('gender',$input)&&array_key_exists('email', $input)
                &&array_key_exists('password', $input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
		  elseif($op == 'user_update') {
                if(!(array_key_exists('firstname',$input)&&array_key_exists('lastname',$input)&&
                array_key_exists('username',$input)&&array_key_exists('dob',$input)&&array_key_exists('user_id',$input)
                &&array_key_exists('gender',$input)&&array_key_exists('email', $input)
               )) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
		   ...
		   elseif($op == 'social_register') {
                if(!(array_key_exists('social_login_id',$input)&&array_key_exists('social_login_type', $input)&&array_key_exists('firstname', $input)
				&&array_key_exists('lastname', $input)&&array_key_exists('email', $input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
         elseif($op == 'check_username') {
                if(!(array_key_exists('username', $input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
		    elseif($op == 'users_of_user') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('user_type',$input)&&array_key_exists('page',$input)
				&&array_key_exists('view_by',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            } 
         elseif($op == 'user_profile') {
                if(!(array_key_exists('user_id',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
		 	elseif($op == 'get_user_posts') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('view_by',$input)
				&&array_key_exists('page',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
		elseif($op == 'getUserLikedPosts') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('view_by',$input)
				&&array_key_exists('page',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
            ...
            } elseif($op == 'get_userpost') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('page',$input)&&array_key_exists('type',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
			elseif($op == 'user_device') {
                if(!(array_key_exists('device_token',$input)&&array_key_exists('device_type', $input)&&array_key_exists('user_id', $input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
			elseif($op == 'user_follow') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('follow_id',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            } 
            elseif($op == 'user_bio') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('bio',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
			 elseif($op == 'create_post') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('post_text',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
			 elseif($op == 'share_post') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('post_id',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
			  elseif($op == 'edit_post') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('post_id',$input)&&array_key_exists('post_text',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
			elseif($op == 'get_a_post') {
                if(!(array_key_exists('post_id',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
            elseif($op == 'userPostLike') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('post_id',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
			elseif($op == 'userPostComment') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('post_id',$input)
				)) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }elseif($op == 'getUsersFeeds') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('page',$input)
				)) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
            elseif($op == 'getShopFeeds') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('keyword',$input)
				)) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
            elseif($op == 'getGenFeeds_v2') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('last_record',$input)
				)) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }elseif($op == 'getUsersFeeds_v2') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('last_record',$input)
				)) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
            ...
            elseif($op == 'product_by_keyword') {
                if(!(array_key_exists('keyword',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }elseif($op == 'userLogout') {
                if(!(array_key_exists('user_id',$input)
				)) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }elseif($op == 'shopProductView') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('product_id',$input)
				)) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            } elseif($op == 'getRecommendation') {
                if(!(array_key_exists('user_id',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
			...
			elseif($op == 'getTrendByKeyword') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('page',$input)&&array_key_exists('keyword',$input)
				)) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
             elseif($op == 'product_by_keyword_advance') {
                if(!(array_key_exists('keyword',$input)&&array_key_exists('category',$input)&&array_key_exists('gender',$input)
				&&array_key_exists('brand',$input)&&array_key_exists('color',$input)
				&&array_key_exists('maxprice',$input)&&array_key_exists('minprice',$input)
				&&array_key_exists('store',$input)&&array_key_exists('page',$input))) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }elseif($op == 'device_register') {
                if(!(array_key_exists('device_model',$input)&&array_key_exists('device_platfrom',$input)
                &&array_key_exists('uuid',$input)&&array_key_exists('device_token',$input)&&array_key_exists('device_type',$input)
				&&array_key_exists('is_debug',$input)
				)) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
            }
			elseif($op == 'userDevice') {
                if(!(array_key_exists('user_id',$input)&&array_key_exists('uuid',$input)
				)) {
                    //$this->response(array('error' => 'Couldn\'t find any users!'), 404);
                    $this->response(array('message'=>'Parameter Missing','status'=>0), 200);  
                }
    ...
    function webservices_get_request_method() {
      return $_SERVER['REQUEST_METHOD'];
    }
    function webservices_inputs(){
      switch($this->webservices_get_request_method()){
        case "POST":
          return $this->webservices_clean_inputs($_POST);
          break;
        case "GET":
        case "DELETE":
          return $this->webservices_clean_inputs($_GET);
          break;
        case "PUT":
          parse_str(file_get_contents("php://input"),$request);
          return $this->webservices_clean_inputs($request);
          break;
        default:
          webservices_send_response('',406);
          break;
      }
    }
    function webservices_clean_inputs($data){
      $clean_input = array();
      if(is_array($data)){
        foreach($data as $k => $v){
          $clean_input[$k] = $this->webservices_clean_inputs($v);
        }
      }
      else {
