...
class Amazon_api
{
	 ...
	 /* Your Amazon Access Key Id
         ...
         * @var string
         */
        var $public_key     = "AKIAJHPEWXMZH55RPNOA";
         ...
         * @var string
         */
        var $private_key    = "7hR8Tkmqf5ISZHAJDk08IhtIsOMY4hPxZq/g+mCL";
         ...
         * @var string
         */
        var $associate_tag  = "stynite-20"; 
     
    
      //  var $associate_tag  = "stynite055-21";
        /*
...
function  aws_signed_request($region,$params,$public_key,$private_key,$associate_tag)
{
    ...
    */
    ...
    else
    {
        ...
        {
        	if($region=='co.uk'){
        		$associate_tag = 'stynite055-21';
        	}else{
        		$associate_tag =  'stynite-20';
        	}
			  
            return $this->aws_signed_request($region, $parameters, $this->public_key,$this->private_key, $associate_tag);
        }
         ...
         * @return mixed simpleXML object
         */
        public function getItemByKeyword($keyword,$product_type,$page=1,$region)
        {
            ...
            return $this->verifyXmlResponse($xml_response);
                ...
                public function searchProductsAdvance($parameters,$region='com')
        {
